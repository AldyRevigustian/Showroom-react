    ...
    return (
        ...
        {isDesktopOrLaptop && 
            <div style={{userSelect:'none', display:'flex', justifyContent:'center', alignItems:'center',backgroundColor:'#393E46', height:'100%'}}>
                <Link style={{ fontSize:12,display: "inline", backgroundColor: '#0D6EFD', padding: '5px 10px 4px 10px', borderRadius: 5, color: 'white', textDecoration: 'none' , fontWeight:'bold'}} to={`/`}><ArrowBack style={{fontSize:14, marginBottom:2, }}/> Back</Link> 
                <Badge bg="danger" style={{margin:'0 0 0 10px',padding: '5px 10px 4px 10px'}}>
                ...
                <Badge bg="success" style={{display:'inline', padding: '5px 10px 4px 10px'}} >
                    <Visibility style={{fontSize:14,marginBottom:2}} /> {names.view_num}
                </Badge> 
