      ...
      {isDesktopOrLaptop &&
        <div style={{ display: 'flex', flexDirection: 'column', flexWrap: 'wrap', }}>
          ...
          <h3 style={{ display: 'flex', justifyContent: 'center', fontSize: 25, fontWeight: 'bold', color: 'white', margin: '15px 0 10px 0', }}>
            <Badge bg="danger">ON AIR <SettingsInputAntennaIcon style={{fontSize:17, marginBottom:2}}/> </Badge>
            </h3>
          ...
          <Badge bg="secondary">MEMBER <PeopleAlt style={{fontSize:20, marginBottom:2}}/></Badge>
          </h3>
            <div className="rows" style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center',}}>
              {memberId.map((member) => {
                return (
